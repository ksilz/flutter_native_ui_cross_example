...
class CrossDropDown extends StatefulWidget {
  final List<SChoice> children;
  final String initialValue;

  const CrossDropDown({Key? key, required this.children, required this.initialValue})
      : assert(children.length > 0),
        assert(initialValue.length > 0),
        super(key: key);

  @override
  State<CrossDropDown> createState() => _CrossDropDownState();
}

class _CrossDropDownState extends State<CrossDropDown> {
